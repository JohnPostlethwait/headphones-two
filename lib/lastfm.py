...
API_KEY = u'814dfef8840cafe972d63d405073f0b8'
API_SECRET = u'5fe1a0e3d4462b1391ddeda101f1714a'
...
class LibFM(object):
    ...
    def __init__(self, api_key='', secret=None):
        ...
        self.secret = secret if secret else API_SECRET
    ...
    def create_mobile_session(self, username, password):
        ...
        response = self._call_method('auth.getMobileSession',
                        {'username' : username, 'authToken' : auth_token,}, 'w')
        self.session_key = response['session']['key']
        return response
    ...
    def _call_method(self, name, args={}, mode='r'):
        ...
        request_args = self._create_request_args(name, args, response_format, mode)
        try:
